...
int main(void)
{
    ...
    // shader
    Shader shader("shaders/framebuffers/blend.vs", "shaders/framebuffers/blend.fs");
    Shader screenShader("shaders/framebuffers/simple.vs", "shaders/framebuffers/simple.fs");
    // box
